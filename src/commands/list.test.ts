...
describe("list command", () => {
  ...
  describe("successful listing", () => {
    it("should list worktrees in table format", () => {
      ...
      expect(success).toHaveBeenCalledWith(
        "Currently in worktree: brave-penguin"
      );
    ...
    it("should handle project with no worktrees", () => {
      ...
      expect(info).toHaveBeenCalledWith(
        "Create a new task with: claudectl new [name]"
      );
    ...
    it("should truncate long commit messages", () => {
      ...
      const longMessage =
        "This is a very long commit message that should be truncated when displayed in the table";
      const mockWorktrees: WorktreeInfo[] = [
        {
          path: "/home/user/test-project",
          branch: "main",
  ...
  describe("error conditions", () => {
    ...
    it("should handle worktree listing failure", () => {
      ...
      expect(() => listCommand()).toThrow(
        "fatal: failed to list tasks: Git command failed"
      );

      expect(fatal).toHaveBeenCalledWith(
        "failed to list tasks: Git command failed"
      );
    });
  });
