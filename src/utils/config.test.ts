...
describe('config utilities', () => {
  ...
  describe('createProjectConfig', () => {
    ...
    it('should validate config with Zod schema', () => {
      ...
      expect(() => createProjectConfig(tempDir, invalidConfig)).toThrow(ZodError);
    });
  ...
  describe('loadProjectConfig', () => {
    ...
    it('should use current working directory when no path provided', () => {
      ...
      expect(() => loadProjectConfig()).toThrow('No claudectl config found. Run \'claudectl init\' first.');
  ...
  describe('updateProjectConfig', () => {
    ...
    it('should validate merged config with Zod schema', async () => {
      ...
      expect(() => updateProjectConfig(tempDir, invalidUpdates)).toThrow(ZodError);
    });
