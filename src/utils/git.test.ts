...
describe('git utilities', () => {
  ...
  describe('getCurrentBranch', () => {
    ...
    it('should throw error for non-git directory', () => {
      ...
      expect(() => getCurrentBranch(nonGitDir)).toThrow('Failed to get current branch');
    });
  });
  ...
  describe('getDefaultBranch', () => {
    ...
    it('should throw error when neither main nor master exists', () => {
      ...
      expect(() => getDefaultBranch(tempDir)).toThrow('Cannot find main or master branch');
    });

    it('should throw error for non-git directory', () => {
      const nonGitDir = join(tempDir, 'not-git');
      
      expect(() => getDefaultBranch(nonGitDir)).toThrow('Failed to determine default branch');
    });
  });
  ...
  describe('worktree operations', () => {
    ...
    describe('createWorktree', () => {
      it('should throw error when no remote origin exists', () => {
        ...
        expect(() => createWorktree(worktreePath, 'feature-1', 'main', repoDir)).toThrow('Failed to create worktree');
      });
      ...
      it('should throw error for non-git directory', () => {
        ...
        expect(() => createWorktree(worktreePath, 'feature-1', 'main', nonGitDir)).toThrow('Failed to create worktree');
      });
    });
    ...
    describe('listWorktrees', () => {
      ...
      it('should throw error for non-git directory', () => {
        ...
        expect(() => listWorktrees(nonGitDir)).toThrow('Failed to list worktrees');
      });
    });
    ...
    describe('removeWorktree', () => {
      it('should throw error when worktree does not exist', () => {
        ...
        expect(() => removeWorktree(nonExistentPath, repoDir)).toThrow('Failed to remove worktree');
      });
      ...
      it('should throw error for non-git directory', () => {
        ...
        expect(() => removeWorktree(worktreePath, nonGitDir)).toThrow('Failed to remove worktree');
      });
    });
  });
});